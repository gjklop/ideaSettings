...
var ${tableInfo.lowerCamelCase}GridUrl = "/${moduleName}/${tableInfo.lowerCamelCase}/list";
var ${tableInfo.lowerCamelCase}AddUrl = "/${moduleName}/${tableInfo.lowerCamelCase}/add";
var ${tableInfo.lowerCamelCase}ModifyUrl = "/${moduleName}/${tableInfo.lowerCamelCase}/modify";
var ${tableInfo.lowerCamelCase}DeleteUrl = "/${moduleName}/${tableInfo.lowerCamelCase}/deleteList";
...
<#list tableInfo.fieldInfos as fieldInfo>
    ...
    ${"$"}("select[name='${fieldInfo.lowerCamelCase}']").combobox({
    	loader: function(param,success,error) {
    		DictUtils.getComboboxDictData({dictTypeCode:"${fieldInfo.lowerCamelCase}"<#if !fieldInfo.isNotNull>,defaultEmpty:true</#if>}, function(data){
    			success(data);
    		});
    	},
        panelHeight:"auto",
...
function ${tableInfo.lowerCamelCase}GridSearch() {
    if(CommonUtils.isNotValidObj(${tableInfo.lowerCamelCase}GridUrl)) {
        return;
    }
